      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  @click="changeActive(spuSaleAttr.spuSaleAttrValueList,spuSaleAttrValue)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model.lazy="num" @change="changeSkuNum"/>
  ...
  methods: {
    ...
    changeSkuNum(event){
      ...
      if(isNaN(value)){
        ...
        this.num = parseInt(value,10)
      }
    },
    async addShoppingCart(){
      // console.log(this.$route.params.skuId)
      try {
        await this.$store.dispatch('getShoppingCart',{skuId:this.skuInfo.id,skuNum:this.num})
        this.$router.push({name:'shopping',query:{num:this.num}})
